...
def logo():
    os.system("clear")  # You may need to adjust this based on your operating system

    print("\033[94m┌────────────────────────────────────────┐".center(os.get_terminal_size().columns + 5))
    print("\033[94m│     \033[1m\033[92mAppstick\033[0m            \033[94m   │".center(os.get_terminal_size().columns + 15))
    print("\033[94m│                              \033[94m          │".center(os.get_terminal_size().columns + 9))
    print("\033[94m│ \033[95mAuthor : AppStick                   \033[94m│".center(os.get_terminal_size().columns + 15))
    print("│ \033[95mTool   : Sms Bomber                \033[94m│".center(os.get_terminal_size().columns + 9))
    print("│ \033[95mWebSite : www.appstick.com.bd       \033[94m│".center(os.get_terminal_size().columns + 9))
    print("│ \033[95mVersion: 2.0.0             \033[94m│".center(os.get_terminal_size().columns + 15))
    print("\033[94m└────────────────────────────────────────┘".center(os.get_terminal_size().columns + 5))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mSpydee\n")
        time.sleep(0.6)
